...
namespace CleanArchitectureMvc.Domain.Tests
{
    public class ProductUnitTest1
    {
        ...
        {
            Action action = () => new Product(1, "Produt Name", "Product Description",9.99m, 99, "product image");
            action.Should()
        ...
        {
            Action action = () => new Product(1, "Produt Name", "Product Description", 9.99m, 99, "product image ");
            action.Should()
                  .Throw<CleanArchitectureMvc.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "Produt Name", "Product Description", 9.99m, 99, null);
            action.Should()
                  .NotThrow<CleanArchitectureMvc.Domain.Validation.DomainExceptionValidation>();
        }
